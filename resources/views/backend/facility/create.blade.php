    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Facility</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Facility Form</h4>
                            @if($showBanner)
                                <p class="f-m-light mt-1">This is the first entry — set the banner and section details, then add your first facility.</p>
                            @else
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-master-facilities.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="image">Facility Image <span class="txt-danger">*</span></label>
