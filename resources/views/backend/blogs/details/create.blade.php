    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Blog Detail</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-blog-details.index') }}">Blog Details</a></li>
                            <li class="breadcrumb-item active">Add Blog Detail</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Blog Detail Form</h4>
                            <p class="f-m-light mt-1">Attach detail content to a published blog. Each blog can have one detail record.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-blog-details.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="blog_listing_id" name="blog_listing_id">
                                                    ...
                                                    @foreach($listings as $listing)
                                                        <option value="{{ $listing->id }}" {{ (string) old('blog_listing_id') === (string) $listing->id ? 'selected' : '' }}>
                                                            {{ $listing->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @if($listings->isEmpty())
                                                    <small class="text-danger">No blogs available. Add a Blog under Blog Listing first, or all blogs already have detail pages.</small>
                                                @else
                                                    <small class="text-muted">Only blogs without a detail page yet are listed.</small>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mt-2">
                                                    <img id="image-preview" src="" alt=""
                                                        style="max-height:200px; max-width:320px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb; display:none;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor-init" id="information" name="information" rows="10"
                                                    placeholder="Full blog content...">{{ old('information') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody id="social-tbody">
                                                    <tr data-row="0">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-danger btn-sm remove-social-row" disabled title="Blank rows are ignored">Remove</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="col-12 text-end">
                                    ...
                                    <button class="btn btn-primary" type="submit" @if($listings->isEmpty()) disabled @endif>Submit</button>
                                </div>
                            </form>
