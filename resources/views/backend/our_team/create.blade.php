                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if($showBanner)
                                <p class="f-m-light mt-1">This is the first entry — set the page banner, section, motto and board details, then add your first team member.</p>
                            @else
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-our-team.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                @if($showBanner)
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <img id="banner_image-preview" src="" alt="" style="max-height:140px; max-width:220px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb; display:none;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-muted">jpg, jpeg, png, webp — max 2MB</small>
                                        <div class="mt-2">
                                            <img id="motto_image-preview" src="" alt="" style="max-height:140px; max-width:220px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb; display:none;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-muted">jpg, jpeg, png, webp — max 2MB</small>
                                        <div class="mt-2">
                                            <img id="board_image-preview" src="" alt="" style="max-height:140px; max-width:220px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb; display:none;">
                                        </div>
                                    </div>
