...
<body>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Join Us Page Details</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Join Us Page Form</h4>
                            <p class="f-m-light mt-1">Fill in each section below.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-join-page.store') }}" method="POST" enctype="multipart/form-data" id="join-us-form">
                                @csrf
                                ...
                                {{-- ===================== INFO TABLE (image + title + editor-desc) ===================== --}}
                                <div class="col-12">
                                    <div class="border rounded p-3">
                                                ...
                                                <tbody id="info-tbody">
                                                    <tr data-row="0">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-danger btn-sm remove-info-row" disabled title="At least one row required">Remove</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="current_job_title" type="text" name="current_job_title"
                                                    value="{{ old('current_job_title') }}" placeholder="Enter Current Job Title">
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor-init" id="current_job_description" name="current_job_description" rows="6"
                                                    placeholder="Enter Description">{{ old('current_job_description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="common_heading" type="text" name="common_heading"
                                                    value="{{ old('common_heading') }}" placeholder="Enter Heading">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="common_title" type="text" name="common_title"
                                                    value="{{ old('common_title') }}" placeholder="Enter Title">
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor-init" id="common_description" name="common_description" rows="6"
                                                    placeholder="Enter Description">{{ old('common_description') }}</textarea>
                                            </div>
                                                    ...
                                                    <table class="table table-bordered align-middle" id="common-table">
                                                        ...
                                                        <tbody id="common-tbody">
                                                            <tr data-row="0">
                                                                ...
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-danger btn-sm remove-common-row" disabled title="At least one row required">Remove</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <div class="col-12">
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label class="form-label" for="extra_background_image">Background Image <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="extra_background_image" type="file" name="extra_background_image"
                                                    accept=".jpg,.jpeg,.png,.webp">
                                                <small class="text-muted">jpg, jpeg, png, webp — max 10MB</small>
                                                <div class="mt-2">
                                                    <img id="extra_background_image-preview" src="" alt=""
                                                        style="max-height:160px; max-width:240px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb; display:none;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor-init" id="extra_description" name="extra_description" rows="6"
                                                    placeholder="Enter Description">{{ old('extra_description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var editorInstances = new Map(); // textarea -> ClassicEditor instance
            ...
            // Init all static editors present on load. Runs after main-js loads CKEditor CDN.
            function initAllEditors() {
                document.querySelectorAll('.ckeditor-init').forEach(initCKEditor);
            }

            if (typeof ClassicEditor === 'undefined') {
                // main-js loads CKEditor over CDN — poll briefly until it's ready.
                var tries = 0;
            ...
            infoAddBtn.addEventListener('click', function () {
                ...
                tr.innerHTML =
                    '<td>' +
                        ...
                        '<small class="text-muted">jpg, png, webp &mdash; max 2MB</small>' +
            ...
            // Delegated file preview for info table rows.
            ...
            /* ---------- COMMON TABLE: add / remove row (plain textarea, no editor) ---------- */
