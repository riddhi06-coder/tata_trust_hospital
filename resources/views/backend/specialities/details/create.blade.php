...
<body>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Speciality Details</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('speciality-details.index') }}">Speciality Details</a></li>
                            <li class="breadcrumb-item active">Add Speciality Details</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input spec-details-form" action="{{ route('speciality-details.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <select class="form-control" id="speciality_id" name="speciality_id" required>
                                        ...
                                        @foreach($specialities as $spec)
                                            <option value="{{ $spec->id }}"
                                                ...
                                                {{ (string) old('speciality_id') === (string) $spec->id ? 'selected' : '' }}>
                                                {{ $spec->speciality }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">jpg, jpeg, png, webp — max 10MB</small>
                                    <div class="mt-2">
                                        <img id="section_image-preview" src="" alt=""
                                            style="max-height:160px; max-width:240px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb; display:none;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="section_heading" type="text" name="section_heading"
                                        value="{{ old('section_heading') }}" placeholder="Enter Section Heading">
                                </div>
                                ...
                                {{-- =============================================================
                                     NORMAL layout fields (hidden when Preventive Care is selected)
                                ============================================================= --}}
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" id="service_heading" type="text" name="service_heading"
                                                value="{{ old('service_heading') }}" placeholder="Enter Service Heading">
                                        </div>
                                                ...
                                                <table class="table table-bordered align-middle mb-0" id="services-table">
                                                    ...
                                                    <tbody id="services-body">
                                                        @php
                                                            ...
                                                            if (!is_array($oldServices) || count($oldServices) === 0) { $oldServices = ['']; }
                                                        @endphp
                                                        @foreach($oldServices as $idx => $svc)
                                                            <tr class="service-row">
                                                                <td class="row-index">{{ $idx + 1 }}</td>
                                                                <td>
                                                                    <textarea class="form-control" name="services[]" rows="2"
                                                                        placeholder="Enter service description">{{ $svc }}</textarea>
                                                                </td>
                                                                <td class="text-end">
                                ...
                                {{-- =============================================================
                                     PREVENTIVE CARE layout (shown only for the Preventive speciality)
                                ============================================================= --}}
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" type="text" id="preventive_section_heading" name="preventive_section_heading"
                                                value="{{ old('preventive_section_heading') }}" placeholder="Enter Section Heading">
                                        </div>

                                        <div class="col-md-12">
                                            <label class="form-label" for="preventive_section_editor">Section Description</label>
                                            <textarea class="form-control preventive-editor" id="preventive_section_editor" name="preventive_section_description" rows="5">{{ old('preventive_section_description') }}</textarea>
                                        </div>

                                        {{-- Services included (image + name) --}}
                                        <div class="col-md-12">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <table class="table table-bordered align-middle mb-0" id="pservice-table">
                                                    ...
                                                    <tbody id="pservice-body">
                                                        <tr class="pservice-row">
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control" name="preventive_service_name[]" placeholder="Enter service name">
                                                            </td>
                                                            <td class="text-end">
                                                                <button type="button" class="btn btn-sm btn-danger remove-pservice">Remove</button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" type="text" id="preventive_plans_heading" name="preventive_plans_heading"
                                                value="{{ old('preventive_plans_heading') }}" placeholder="Enter Heading">
                                        </div>

                                        <div class="col-md-12">
                                            <label class="form-label" for="preventive_plans_editor">Description</label>
                                            <textarea class="form-control preventive-editor" id="preventive_plans_editor" name="preventive_plans_description" rows="5">{{ old('preventive_plans_description') }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div id="plan-categories">
                                                <div class="plan-category-block border rounded p-3 mb-3" data-block="0">
                                                    <div class="row g-3 align-items-end mb-3">
                                                        <div class="col-md-12">
                                                            <label class="form-label">Category Name</label>
                                                            <input type="text" class="form-control" name="plan_category[0]" placeholder="Enter Category Name">
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        ...
                                                        <table class="table table-bordered align-middle mb-0 plan-table">
                                                            <thead class="table-light">
                                                                <tr>
                                                                    ...
                                                                    <th>Name</th>
                                                                    <th style="width:160px;">Age Range</th>
                                                            ...
                                                            <tbody class="plan-rows">
                                                                <tr class="plan-row">
                                                                    <td class="row-index">1</td>
                                                                    <td>
                                                                        <input type="file" class="form-control row-image" name="plan_image[0][]" accept=".jpg,.jpeg,.png,.webp">
                                                                        <input type="hidden" name="plan_existing[0][]" value="">
                                                                        <small class="text-muted d-block mt-1">jpg, jpeg, png, webp — max 10MB</small>
                                                                        <img class="row-image-preview mt-2" src="" alt="" style="max-height:70px;border-radius:6px;border:1px solid #e5e7eb;display:none;">
                                                                    </td>
                                                                    <td><input type="text" class="form-control" name="plan_name[0][]" placeholder="Plan name"></td>
                                                                    <td><input type="text" class="form-control" name="plan_age_range[0][]" placeholder="e.g. 0-1 yr"></td>
                                                                    <td><input type="text" class="form-control" name="plan_cost[0][]" placeholder="e.g. ₹2000"></td>
                                                                    <td class="text-end">
                                                                        <button type="button" class="btn btn-sm btn-danger remove-plan">Remove</button>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control preventive-editor" id="preventive_disclaimer_editor" name="preventive_disclaimer" rows="4">{{ old('preventive_disclaimer') }}</textarea>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            /* ---------- preventive: services included repeater ---------- */
            ...
            var blockCounter = 1; // block 0 is rendered server-side
            ...
            /* ---------- CKEditor for the preventive editors (lazy, on first reveal) ---------- */
            ...
            /* ---------- mode toggle: normal vs preventive ---------- */
            ...
            function applyMode() {
                ...
                if (isPreventive) {
                    ...
                    preventiveWrap.style.display = '';
                    initPreventiveEditors();
                } else {
                    normalWrap.style.display = '';
                    preventiveWrap.style.display = 'none';
                }
            }
            specSelect.addEventListener('change', applyMode);
            applyMode(); // honor old() selection after a validation error
        });
    </script>
</body>
</html>
