                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('speciality-details.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="speciality_id" name="speciality_id" required>
                                        ...
                                        @foreach($specialities as $spec)
                                            <option value="{{ $spec->id }}" {{ (string) old('speciality_id') === (string) $spec->id ? 'selected' : '' }}>
                                                {{ $spec->speciality }}
                                            </option>
                                        @endforeach
                                    </select>
                                        ...
                                        <table class="table table-bordered align-middle mb-0" id="services-table">
                                            ...
                                            <tbody id="services-body">
                                                @php
                                                    ...
                                                    if (!is_array($oldServices) || count($oldServices) === 0) {
                                                        $oldServices = [''];
                                                    }
                                                @endphp
