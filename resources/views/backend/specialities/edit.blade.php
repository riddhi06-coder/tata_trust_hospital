    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Edit Speciality</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if($showBanner)
                                <p class="f-m-light mt-1">This is the first entry — banner and service section details are edited here.</p>
                            @else
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-specialities.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <img id="banner_image-preview"
                                                src="{{ $hasBanner ? asset('home/specialities/'.$settings->banner_image) : '' }}"
                                                data-existing="{{ $hasBanner ? asset('home/specialities/'.$settings->banner_image) : '' }}"
                                                alt=""
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="speciality" type="text" name="speciality"
                                        value="{{ old('speciality', $item->speciality) }}"
                                        placeholder="Enter Speciality Name">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label" for="image">Replace Speciality Image</label>
                                    <input type="file" id="image" name="image" accept="image/*" class="form-control">
                                    <small class="text-muted">Leave blank to keep current. jpg, jpeg, png, webp — max 5MB.</small>
                                    <div class="mt-2">
                                        <img id="image-preview"
                                            src="{{ asset('home/specialities/'.$item->image) }}"
                                            data-existing="{{ asset('home/specialities/'.$item->image) }}"
                                            alt=""
