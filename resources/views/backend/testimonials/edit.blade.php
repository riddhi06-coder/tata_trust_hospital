                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-master-testimonials.update', $testimonial->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="name" type="text" name="name" value="{{ old('name', $testimonial->name) }}" placeholder="e.g. John Doe">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="testimony" id="editor" class="form-control" rows="6" placeholder="Write the testimony here…">{{ old('testimony', $testimonial->testimony) }}</textarea>
                                </div>
