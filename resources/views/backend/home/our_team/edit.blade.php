    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Edit Our Team</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('home-team.update', $team->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="title" type="text" name="title" value="{{ old('title', $team->title) }}" placeholder="Enter Title">
                                </div>

                                <!-- Description -->
                                <div class="col-md-12">
                                    <label class="form-label">Description <span class="txt-danger">*</span></label>
                                    <textarea name="description" id="editor" class="form-control" rows="6" placeholder="Enter Description">{{ old('description', $team->description) }}</textarea>
                                </div>
