                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-board.update', $board->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="image_caption" type="text" name="image_caption" value="{{ old('image_caption', $board->image_caption) }}" placeholder="e.g. Late Mr Ratan N. Tata">
                                </div>

                                <!-- Designation (shown as image subtitle on the home page) -->
                                <div class="col-md-6">
                                    <label class="form-label" for="image_subtitle">Designation</label>
                                    <input class="form-control" id="image_subtitle" type="text" name="image_subtitle" value="{{ old('image_subtitle', $board->image_subtitle) }}" placeholder="e.g. Founder and Chairman Emeritus">
                                </div>
