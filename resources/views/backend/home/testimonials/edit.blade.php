    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Edit Testimonials</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @php $hasImage = !empty($testimonial->image); @endphp

                            <form class="row g-3 custom-input" action="{{ route('manage-testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="title" type="text" name="title" value="{{ old('title', $testimonial->title) }}" placeholder="Enter Heading">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-2">
                                        <img id="image-preview"
                                             src="{{ $hasImage ? asset('home/testimonials/'.$testimonial->image) : '' }}"
                                             alt=""
                                             data-existing="{{ $hasImage ? asset('home/testimonials/'.$testimonial->image) : '' }}"
