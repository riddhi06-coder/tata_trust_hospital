    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Follow Us</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-follow-us.index') }}">Home</a></li>
                            <li class="breadcrumb-item active">Add Follow Us</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-follow-us.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="social_media_link" type="url" name="social_media_link" value="{{ old('social_media_link') }}" placeholder="https://www.facebook.com/yourpage">
                                </div>
