    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Flyer</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-flyer.index') }}">Flyers</a></li>
                            <li class="breadcrumb-item active">Add Flyer</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-flyer.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
