    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add FAQ</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>FAQ Form</h4>
                            @if($showBanner)
                                <p class="f-m-light mt-1">This is the first entry — set the banner and section details, then add your first Q &amp; A.</p>
                            @else
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-faqs.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
