...
<html lang="en">
    ...
    <body class="ty-page-body">
        <div class="ty-card">
            ...
            <div class="ty-body">
                <h1>Thank You!</h1>
                <p>Your appointment request has been received successfully.</p><br>
                <p>Our team will review the details and contact you shortly to confirm your visit.</p>
                <p class="sub">A confirmation has been sent to your email address.</p>

                <div class="ty-note">
                    This is a tentative appointment booking. You will receive a confirmation call from our Customer Care
                    Department. Please contact <a href="tel:02265383538">022-6538-3538</a> for any information.
                </div>
